...
import "./card.css";
import "./card2.css";
const ServiceCard = ({ index, title, icon,cname }) => (

 
  <Tilt className='xs:w-[250px] w-full'>
    <motion.div
      variants={fadeIn("right", "spring", index * 0.5, 0.75)}
      className={`parent w-full  shadow-card  animated card ${cname}`}
    >
       ...
       <div
        ...
        className='bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col  animated content-box '
      ...
      >
        ...
        <h3 className='text-white text-[20px] font-bold text-center card-title'>
          {title}
        </h3>
      </div>
